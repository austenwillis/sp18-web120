...
#EDIT THE FOLLOWING:
$toAddress = "austen.willis@seattlecentral.edu";  //place your/your client's email address here
$toName = "Austen"; //place your client's name here
$website = "Web 120 Big";  //place NAME of your client's website here
#--------------END CONFIG AREA ------------------------#
...
?>
	...
	<h2>Booking, Questions, and Comments</h2>
        <div>
		<label>
	...
	<div>	
		<fieldset>
			...
			<input type="checkbox" name="Interested_In[]" value="Booking" tabindex="40" />Booking<br />
			<input type="checkbox" name="Interested_In[]" value="Questions" />Questions <br />
			<input type="checkbox" name="Interested_In[]" value="Comments" /> Comments<br />
		...
		<div>	
		<fieldset>
			<legend>Would you like to join the Red Alder mailing list?</legend>
